...
class Branches extends CI_Controller {
	...
	public function index()
	{
		...
		$this->data['page_id']="branches";
		$this->data['page_title']="All branches Lists  | CargoAdmin";
		$config = array();
		$searchqry = array();
	...
	{ 
		...
		$this->data['page_id']="branches_create";
		$this->data['page_title']="Add new Branch  | CargoAdmin";
		$this->load->view('head/admin_header',$this->data);
	...
	public function update()
	{
		if($this->uri->segment(3)==null){
        	...
        	redirect(base_url().'branches');
				...
				$this->load->view('head/admin_header',$this->data);
				$this->load->view('branches/update');
				$this->load->view('head/admin_footer');
			}
		}
	}
	public function update_process()
	{
		...
		if (empty( $this->input->post('password') )) {
        	...
        	redirect(base_url().'branches/update/'.$uiid);
		}
		else{ 
