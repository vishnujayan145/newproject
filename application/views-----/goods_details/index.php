                            ...
                            <div class="row mt-2">   
                                <div class="col-md-3"> 
                                        <div class="btn-group mt-4"  role="group" aria-label="Basic outlined example">
                                            <button type="button" class="btn btn-outline-warning"><input type="submit" class="form-control" name="download_to_import" value="Download"></button>
                                            <button type="button" class="btn btn-outline-warning" ><input type="submit" class="form-control" name="download_loading" value="Loading List"></button>
                                            <button type="button" class="btn btn-outline-warning" > <input type="submit" class="form-control" name="download_sorting" value="Sorting List"></button>
                                            <button type="button" class="btn btn-outline-warning" > <input type="submit" class="form-control" name="download_ogm" value="OGM"></button> 
                                        </div>
                                ...
                                <div class="col-md-1"><label for="example-select">Filter</label>                                                                                
                                ...
                                <div class="col-md-1 pr-0 pl-0"><label for="example-select">&nbsp;&nbsp;</label>                                
                                    <button type="submit" class="btn btn-secondary mt-4 search_btn">
