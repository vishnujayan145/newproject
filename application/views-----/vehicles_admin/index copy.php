                    ...
                    <div class="block">
                        <div class="block-header block-header-default">
                            <span class="block-title">
                                 <h2 class="content-heading">List all Vehicles</h2>
                            </span>
                                                <a href="<?=base_url()?>vehicles_admin/create" class="btn btn-alt-primary">
                                                    <i class="fa fa-plus mr-5"></i>Add Vehicle</a>
                        </div>
                        <div>
                            
                            
                        <form action="<?=base_url()?>vehicles_admin/index?" method="get" name="myxfrm" enctype="multipart/form-data" onsubmit="return validateForm();">
...
?>
                                        <tr>
                                            ...
                                            <td>
                                                <?=$resultvlu->vehicle_type?>
                                            </td>
                                            <td>
                                                <?=$resultvlu->driver_name?>
                                            </td>
                                            <td>
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group">
                                                    <a href="<?=base_url()?>vehicles_admin/update/<?=$resultvlu->id?>" class="btn btn-sm btn-secondary" data-toggle="tooltip" title="Edit">
