            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <form action="<?= base_url() ?>trip_sheet_admin/create_process" method="post" name="myxfrm"    enctype="multipart/form-data" onsubmit="return validateForm();">
                                ...
                                */ ?>
                                ...
                                <div> 
                                    ...
                                    <input type="hidden" name="branch_id" value="<?= $this->session->userdata['adminloginel']['id'] ?>" />  
                                        ...
                                        <div class=" ">
                                        <a href="<?= base_url() ?>trip_sheet_admin" class="btn btn-primary">Back</a> &nbsp;<button
...
<script type="text/javascript">
    ...
    function vendornamechange(sbid) {
        ...
        $.ajax({
            type: "GET",
            url: "<?php echo base_url() ?>trip_sheet_admin/serach_vendor_id/" + sbid,
            dataType: "json",
            cache: false,
            success: function (result) {
