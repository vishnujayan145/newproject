                ...
                <div class="content">
                    ...
                    <div class="block">
                        ...
                        <div class="block-header block-header-default">
                            ...
                            <a href="<?=base_url()?>trip_sheet/create" class="btn btn-alt-primary">
                                                    ...
                                                    <?php
                                                        ...
                                                        if($resultvlu->status==0){
                                                            ...
                                                            echo " <span class='badge badge-secondary'>On the Way</span>";
                                                             ...
                                                             echo " <span class='badge badge-success'>Trip Finished</span>";

                                                        } 
                                                        else if($resultvlu->status==7){

                                                            echo " <span class='badge badge-info'>Trip Created</span>";
