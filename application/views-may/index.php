                        ...
                        <div class="row">
                                    ...
                                    <div class="card-body pt-0">
                                        <div class="row">
                                            <div class="col-sm-4">
                                                ...
                                                <p class="text-muted mb-0 text-truncate"><?=$this->session->userdata['adminloginel']['role']?></p>
                                            </div>
                            ...
                            <?php if( isset($pending_invoices)) { ?>
                                <div class="row">   
                                    <div class="col-md-4">
                                        <div class="card mini-stats-wid">
                                            <div class="card-body" style="background-color: #c33030;">  
                                                <div class="d-flex">
                                                    <div class="flex-grow-1">
                                                        <p class="text-muted fw-medium" style="font-size: 1.5rem;">Pending invoice</p>
                                    ...
                                    <div class="col-md-4">
                                        <div class="card mini-stats-wid">
                                            <div class="card-body" style="background-color:  #564747;">
                                                <div class="d-flex">
                                                    <div class="flex-grow-1">
                                                        <p class="text-muted fw-medium" style="font-size: 1.5rem;">Not delivered Invoice</p>
                                    ...
                                    <div class="col-md-4">
                                        <div class="card mini-stats-wid">
                                            <div class="card-body" style="background-color: #3b3a68;">
                                                <div class="d-flex">
                                                    <div class="flex-grow-1">
                                                        <p class="text-muted fw-medium" style="font-size: 1.5rem;">Not Delivered Goods</p>
                                ...
                                <div class="row">   
                                    <div class="col-md-4">
                                        <div class="card mini-stats-wid">
                                            <div class="card-body" style="background-color: #a7a6d6;">
                                                <div class="d-flex">
                                                    <div class="flex-grow-1">
                                                        <p class="text-muted fw-medium" style="font-size: 1.5rem;">Holding Goods Count</p>
                                    ...
                                    <div class="col-md-2">
                                        <div class="card mini-stats-wid">
                                            <div class="card-body" style="background-color: #1fd02a;">
                                                <div class="d-flex">
                                                    <div class="flex-grow-1">
                                                        <p class="text-muted fw-medium" style="font-size: 1.5rem;">Short  </p>
                                    ...
                                    <div class="col-md-3">
                                        <div class="card mini-stats-wid">
                                            <div class="card-body" style="background-color: #0a4e0e;">
                                                <div class="d-flex">
                                                    <div class="flex-grow-1">
                                                        <p class="text-muted fw-medium" style="font-size: 1.5rem;">On the way</p>
                                    ...
                                    <div class="col-md-3">
                                        <div class="card mini-stats-wid">
                                            <div class="card-body" style="background-color: #ada876;">
                                                <div class="d-flex">
                                                    <div class="flex-grow-1">
                                                       

                                                        <p class="text-muted fw-medium" style="font-size: 1.5rem;">Trip started</p>
