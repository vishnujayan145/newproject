                        ...
                        <div class="block-header block-header-default">
                            <span class="block-title">
                                 <h2 class="content-heading">List all Vehicles</h2>
                                                ...
                                                <a href="<?=base_url()?>vehicles/create" class="btn btn-alt-primary">
...
?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group">
                                                    <a href="<?=base_url()?>vehicles/update/<?=$resultvlu->id?>" class="btn btn-sm btn-secondary" data-toggle="tooltip" title="Edit">
