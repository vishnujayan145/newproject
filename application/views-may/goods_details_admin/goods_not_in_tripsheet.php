        ...
        <div class="block" style="">
            <div class="block-header block-header-default" style="    padding: 0px;">
                 <span class="block-title" style="    padding: 0px;">
                     <h2 class="content-heading" style="    padding: 0px;">Goods Not In Tripsheet</h2>
                 </span>
                 <?php /*
        ...
        <div>
                 ...
                 <form action="<?= base_url() ?>goods_details/goodsNotInTripsheet?" method="get" name="myxfrm" enctype="multipart/form-data" onsubmit="return validateForm();">
                     ...
                     <div class="dropdown float-right mr-3">
                         <label for="example-select">Export</label>
                         <div>
                             <input type="submit" class="form-control" name="export_goods_not_in_tripsheet" value="Download Goods Not in Tripsheet">
                         </div>
                     </div>
                     <?php /*
                     <div class="dropdown float-right mr-3">
