<main id="main-container">
                ...
                <!-- Page Content -->
                <div class="content">
                    <h2 class="content-heading">Import TripSheet</h2>
                        ...
                        <div class="block-content">
                            <div class="block">
                                <div class="block-header block-header-default">
                                    <h3 class="block-title">Import Trip Sheet</h3>
                                </div>
                                <div class="block-content">
                                     <form action="<?=base_url()?>trip_sheet/import_process" method="post" name="myxfrm" enctype="multipart/form-data" onsubmit="return validateForm();">
                                        ...
                                        <div class="form-group">
                                            <a href="<?=base_url()?>trip_sheet" class="btn btn-alt-primary">Back</a> &nbsp;<button type="submit" class="btn btn-alt-success">Import Data</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
