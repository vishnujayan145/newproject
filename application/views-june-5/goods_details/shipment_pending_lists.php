        ...
        function showStatusModel(cargo_id_val, rewight, recieved_pcs, recieved_at_hub, connecting_date,vendor,docket,status,remarks) {
          console.log("*");
           ...
           $('#asignModel').modal('show', {
            ...
            $("#editForm").find("#rewight").val(rewight);
            $("#editForm").find("#recieved_pcs").val(recieved_pcs);
            $("#editForm").find("#recieved_at_hub").val(recieved_at_hub);
            $("#editForm").find("#connecting_date").val(connecting_date);
            $("#editForm").find("#vendor").val(vendor);
            $("#editForm").find("#docket").val(docket);
            $("#editForm").find("#status").val(status);
            $("#editForm").find("#remarks").val(remarks);
            $("#editForm").find("#uid").val(cargo_id_val);
