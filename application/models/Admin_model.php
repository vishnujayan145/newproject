...
//   echo $qry; die;
    ...
    { 
        $offset = ($start-1)*$limit;  
        $query = $this->db
                ->select('goods_details.id, goods_status.goods_status as cur_status, trip_sheet_cargos.*,trip_sheet.vehicle_number as vehicle_number , trip_sheet.vehicle_drivername as vehicle_drivername, branches.branch_name,trip_sheet.destination as destination ,trip_sheet.trip_sheet_name as trip_sheet_name  , trip_sheet_cargos.status as cargo_status ')
                ->join( 'trip_sheet_cargos', 'trip_sheet_cargos.goods_id=goods_details.id' ,'left')
                ...
                ->join( 'goods_status', 'goods_details.current_status_id=goods_status.id' ,'left') 
                ->like($condition) 
...
/*
    public function get_reports_count($condition   ){
        if($condition){ 
            ...
            $query = $this->db   
                    ->select('goods_details.*, goods_status.goods_status as cur_status,  trip_sheet_cargos.*,trip_sheet.vehicle_number as vehicle_number , trip_sheet.vehicle_drivername as vehicle_drivername, branches.branch_name ,trip_sheet.destination as destination,trip_sheet.trip_sheet_name as trip_sheet_name     , trip_sheet_cargos.status as cargo_status')
                    ->join( 'trip_sheet_cargos', 'trip_sheet_cargos.goods_id=goods_details.id' ,'left')
                    ->join( 'trip_sheet', 'trip_sheet_cargos.trip_sheet_id=trip_sheet.id' ,'left') 
                    ->join( 'branches', 'trip_sheet_cargos.branch_id=branches.id' ,'left') 
                    ->join( 'goods_status', 'goods_details.current_status_id=goods_status.id' ,'left') 
    ...
    public function get_reports($condition ,$limit, $start )
    {
        ...
        if($condition){ 
            $offset = ($start-1)*$limit;  
            $query = $this->db  
                    ->select('goods_details.*, goods_details.id, goods_status.goods_status as cur_status, trip_sheet_cargos.*,trip_sheet.vehicle_number as vehicle_number , trip_sheet.vehicle_drivername as vehicle_drivername, branches.branch_name,trip_sheet.destination as destination ,trip_sheet.trip_sheet_name as trip_sheet_name  , trip_sheet_cargos.status as cargo_status ')
                    ->join( 'trip_sheet_cargos', 'trip_sheet_cargos.goods_id=goods_details.id' ,'left')
                    ->join( 'trip_sheet', 'trip_sheet_cargos.trip_sheet_id=trip_sheet.id' ,'left')
                    ->join( 'branches', 'trip_sheet_cargos.branch_id=branches.id' ,'left') 
                    ->join( 'goods_status', 'goods_details.current_status_id=goods_status.id' ,'left') 
...
public function get_reports_count($condition   ){
    if($condition){ 
        ...
        $query = $this->db  
                ->select('shipment_details.id, goods_status.goods_status as cur_status, trip_sheet_cargos.*,trip_sheet.vehicle_number as vehicle_number , trip_sheet.vehicle_drivername as vehicle_drivername, branches.branch_name,trip_sheet.destination as destination ,trip_sheet.trip_sheet_name as trip_sheet_name  , trip_sheet_cargos.status as cargo_status ')
                ->join( 'trip_sheet_cargos', 'trip_sheet_cargos.goods_id=shipment_details.id' ,'left')
                ->join( 'trip_sheet', 'trip_sheet_cargos.trip_sheet_id=trip_sheet.id' ,'left')
                ->join( 'branches', 'trip_sheet_cargos.branch_id=branches.id' ,'left') 
                ->join( 'goods_status', 'shipment_details.current_status_id=goods_status.id' ,'left')  
                ->join( 'shipment_status', 'shipment_details.shipment_status_id=shipment_status.id' ,'left') 
        ...
        $query = $this->db   
                ->select('shipment_details.*, goods_status.goods_status as cur_status,  trip_sheet_cargos.*,trip_sheet.vehicle_number as vehicle_number , trip_sheet.vehicle_drivername as vehicle_drivername, branches.branch_name ,trip_sheet.destination as destination,trip_sheet.trip_sheet_name as trip_sheet_name     , trip_sheet_cargos.status as cargo_status')
                ->join( 'trip_sheet_cargos', 'trip_sheet_cargos.goods_id=shipment_details.id' ,'left')
                ->join( 'trip_sheet', 'trip_sheet_cargos.trip_sheet_id=trip_sheet.id' ,'left') 
                ->join( 'branches', 'trip_sheet_cargos.branch_id=branches.id' ,'left') 
                ->join( 'goods_status', 'shipment_details.current_status_id=goods_status.id' ,'left') 
...
public function get_reports($condition ,$limit, $start )
{
    ...
    if($condition){ 
        $offset = ($start-1)*$limit;  
        $query = $this->db  
                ->select('shipment_details.*, shipment_details.id, shipment_status.shipment_status as shipment_status, goods_status.goods_status as cur_status, trip_sheet_cargos.*,trip_sheet.vehicle_number as vehicle_number , trip_sheet.vehicle_drivername as vehicle_drivername, branches.branch_name,trip_sheet.destination as destination ,trip_sheet.trip_sheet_name as trip_sheet_name  , trip_sheet_cargos.status as cargo_status ')
                ->join( 'trip_sheet_cargos', 'trip_sheet_cargos.goods_id=shipment_details.id' ,'left')
                ->join( 'trip_sheet', 'trip_sheet_cargos.trip_sheet_id=trip_sheet.id' ,'left')
                ->join( 'branches', 'trip_sheet_cargos.branch_id=branches.id' ,'left') 
                ->join( 'goods_status', 'shipment_details.current_status_id=goods_status.id' ,'left') 
        ...
        $offset = ($start-1)*$limit;  
        $query = $this->db   
                ->select('shipment_details.*, goods_status.goods_status as cur_status,shipment_status.shipment_status as shipment_status,  trip_sheet_cargos.*,trip_sheet.vehicle_number as vehicle_number , trip_sheet.vehicle_drivername as vehicle_drivername, branches.branch_name ,trip_sheet.destination as destination,trip_sheet.trip_sheet_name as trip_sheet_name     , trip_sheet_cargos.status as cargo_status')
                ->join( 'trip_sheet_cargos', 'trip_sheet_cargos.goods_id=shipment_details.id' ,'left')
                 ->join( 'trip_sheet', 'trip_sheet_cargos.trip_sheet_id=trip_sheet.id' ,'left') 
                ->join( 'branches', 'trip_sheet_cargos.branch_id=branches.id' ,'left') 
                ->join( 'goods_status', 'shipment_details.current_status_id=goods_status.id' ,'left') 
