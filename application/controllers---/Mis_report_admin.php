...
class Mis_report_admin extends CI_Controller
{
    ...
    // die;
        ...
        $this->load->view('mis_report_admin/index',$data);
    ...
    public function export_post()
    {
        ...
        if(!empty($this->input->post('shipmentname') )) {           
            ...
            if( $this->input->post('from') !='' && $this->input->post('to')!='') {
                $condition.= " AND `gd`.`created_at` BETWEEN '". $this->input->post('from')."' AND '".$this->input->post('to')."'";
            }
        }
