...
*/
    ...
    public function reports()
    {
        ...
        if(isset($_GET['branch_id']) && $_GET['branch_id']!=null && $_GET['branch_id']!='all'){            
            $searchqry = array_merge($searchqry,array("trip_sheet_cargos.branch_id"=>$_GET['branch_id'] ));
        }
      
        //   $searchqry .=" AND trip_sheet_cargos.branch_id='".$branch_id."'";
        ...
        $total_row = $this->admin_model->count_all_data_condition_ordersearch_admin('trip_sheet_cargos', $data_cndtn, 'trip_sheet_cargos.id', 'DESC', $searchqry, 'branches', $join_cond);
        ...
        $data['result'] = $this->admin_model->get_reports_admin($searchqry ,$config["per_page"], $page);
