                                                    ...
                                                    <?php
                                                      ...
                                                      foreach ($result as $key => $resultvlu) {
                                                        ...
                                                        if($resultvlu->cur_status == null) {
                                                             if ($resultvlu->customs_cleared_date == NULL) { 
                                                                $cur_status = "Waiting for Customs clearence";
                                                          ...
                                                          /*
                                                          if($resultvlu->cargo_status==0){
                                                              $st="On the Way";
                                                          }else if($resultvlu->cargo_status==1){
                                                              $st="Out for Delivery";
                                                          }else if($resultvlu->cargo_status==2){
                                                              $st="In Transit";
                                                          }else if($resultvlu->cargo_status==3){
                                                              $st="Delivered";
                                                          }else if($resultvlu->cargo_status==4){
                                                              $st="Pending";
                                                          }else if($resultvlu->cargo_status==5){
                                                              $st="Not Delivered";
                                                          }else if($resultvlu->cargo_status==6){
                                                              $st="Recheck";
                                                          } */
                                                      ...
                                                      ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <?=$resultvlu->quantity??$resultvlu->pcs?>
                                                            </td>
                                                            <td>
                                                                <?=$resultvlu->weight?>
                                                            </td>
