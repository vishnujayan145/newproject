                        ...
                        <div class="card-body">
                            ...
                            <form action="<?= base_url() ?>trip_sheet/create_process" method="post" name="myxfrm" enctype="multipart/form-data" onsubmit="return validateForm();">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-4 col-md-4 mb-3 ">
                                        <div class="form-group">
                                            ...
                                            <input type="date" value="<?php echo $today; ?>" class="form-control" name="trip_date" id='trip_date' placeholder="Trip Date..">
                                        </div>
                                    </div>
                                    <div class="col-4 col-md-4  mb-3 ">
                                        <div class="form-group">
                                            <label for="example-nf-email">Trip Time</label>
                                            <input type="time" class="form-control" value="<?php echo $currentTime; ?>" name="trip_time" id='trip_time' placeholder="Trip Time..">
                                        </div>
                                    </div>
                                    <div class="col-4 col-md-4  mb-3 ">
                                        <div class="form-group">
                                            <label for="example-nf-email">Estimated Arrival Date</label>
                                            <input type="date" value="<?php echo $today; ?>" class="form-control" name="estimate_arrival_date" id='estimate_arrival_date' placeholder="Estimated Arrival Date">
                                        </div>
                                    </div>
                                    <div class="col-4 col-md-4  mb-3 ">
                                        <div class="form-group">
                                    ...
                                    <div class="col-4 col-md-4 mb-3">
                                        <div class="form-group">
                                            ...
                                            <div>
                                                <select class="form-control" id="vendor_or_vehicle" name="vendor_or_vehicle" onchange="vendor_or_vehiclechange(this.value)" required>
                                    ...
                                    <div class="col-4 col-md-4  mb-3  vehicle">
                                        <div class="form-group">
                                            ...
                                            <div>
                                                <select class="form-control select2" id="vehicle_number" name="vehicle_number" onchange="vehiclenumberchange(this.value)" onclick="vehiclenumberchange(this.value)">
                                    ...
                                    <div class="col-4 col-md-4  mb-3  vendor">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2" id="vendor_id" name="vendor_id" onchange="vendornamechange(this.value)" onclick="vendornamechange(this.value)">
                                    ...
                                    <div class="col-4 col-md-4  mb-3  vendor">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="vendor_location" id='vendor_location' placeholder="vendor location..">
                                            <input type="hidden" class="form-control" name="vendor_name" id='vendor_name' placeholder="vendor location.." value="">
                                        </div>
                                    </div>
                                    <div class="col-4 col-md-4  mb-3  vendor">
                                        <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-4 col-md-4  mb-3 ">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="start_km" id='start_km' placeholder="Start K.M.." value="0" onkeyup="totalkmx();">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-4 col-md-4  mb-3 ">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="stop_km" id='stop_km' placeholder="Stop K.M.." value="0" onkeyup="totalkmx();">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-4 col-md-4  mb-3 ">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="total_km" id='total_km' placeholder="Total K.M.." value="0">
                                        </div>
                                    </div>
                                ...
                                */ ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-4 col-md-4  mb-3 ">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="exp_diesel" id='exp_diesel' placeholder="Diesel Amt.." value="0" onkeyup="expensetotalx();">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-4 col-md-4  mb-3 ">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="exp_batha" id='exp_batha' placeholder="Batha Amt.." value="0" onkeyup="expensetotalx();">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-4 col-md-4  mb-3 ">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="exp_phone" id='exp_phone' placeholder="Phone Exp.." value="0" onkeyup="expensetotalx();">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-4 col-md-4  mb-3 ">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="exp_toll" id='exp_toll' placeholder="Toll Exp.." value="0" onkeyup="expensetotalx();">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-4 col-md-4  mb-3 ">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="exp_food" id='exp_food' placeholder="Food Amt.." value="0" onkeyup="expensetotalx();">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-4 col-md-4  mb-3 ">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="exp_other" id='exp_other' placeholder="Other Exp.." value="0" onkeyup="expensetotalx();">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-4 col-md-4  mb-3 ">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="exp_total" id='exp_total' placeholder="Expense Total.." value="0" onkeyup="balanceamountx();">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-4 col-md-4  mb-3 ">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="exp_advance" id='exp_advance' placeholder="Advance Amt.." value="0" onkeyup="balanceamountx();">
                                        </div>
                                    </div>
                                ...
                                <div class=" ">
                                    <a href="<?= base_url() ?>trip_sheet" class="btn btn-primary">Back</a> &nbsp;<button type="submit" class="btn btn-success">Complete
                                    </button>
                                </div>
...
<script>
    function vendor_or_vehiclechange(value) {
