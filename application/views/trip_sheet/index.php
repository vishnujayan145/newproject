                                        ...
                                        <tr style="<?=$bgcolor?>">
                                          ...
                                          <td class="text-center">
                                                            <div class="btn-group" role="group" aria-label="Basic outlined example">
                                                                ...
                                                                <?php if ($resultvlu->destination == 'other_state') { ?>
                                                                    <button type="button" class="btn btn-outline-secondary" onclick="location.href='<?= base_url() ?>trip_sheet/cargos_other_state/<?= $resultvlu->trip_sheet_name ?>'">
                                                                        <i class="fa fa-truck" style="font-size: 22px"></i></button>
                                                                <?php } else { ?>
                                                                    <button type="button" class="btn btn-outline-secondary" onclick="location.href='<?= base_url() ?>trip_sheet/cargos/<?= $resultvlu->trip_sheet_name ?>'">
                                                                        <i class="fa fa-truck" style="font-size: 22px"></i></button>
