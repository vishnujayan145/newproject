            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <form action="<?=base_url()?>goods_details_admin/update_process" method="post" name="myxfrm" enctype="multipart/form-data" onsubmit="return validateForm();">
                                        ...
                                        <div class="row"> 
                                                ...
                                                <div class="col-4 col-md-4 mb-3">
                                                    <div class="form-group">
                                                        <label for="example-select">Agency Name</label>
                                                        <input type="text" class="form-control" name="agencyname" placeholder="Enter agency name.." value="<?=$agencyname?>">
                                                    </div>
                                                </div>
                                        ...
                                        <div class=" ">
                                            <a href="<?=base_url()?>goods_details_admin" class="btn btn-primary">Back</a> &nbsp;
                                            <a href="<?=base_url()?>goods_details_admin/delete_process/<?=$id?>" class="btn btn-danger mr-2">Delete</a>&nbsp;<button type="submit" class="btn btn-success">Update Now</button>
                                        </div>
