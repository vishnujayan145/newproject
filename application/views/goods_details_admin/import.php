            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <form action="<?= base_url() ?>goods_details_admin/import_process" method="post" name="myxfrm"
                            ...
                            <div id="ermsg" class="col-4"> <?= $this->session->flashdata('msgx'); ?>  </div>
                                        ...
                                        <div class="">
                                            <a href="<?=base_url()?>goods_details_admin" class="btn btn-primary">Back</a> &nbsp;<button type="submit" class="btn btn-success">Import Data</button>
                                        </div>
                                </form> 
