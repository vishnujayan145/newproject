                          ...
                          <div class="block-content ">
                            ...
                            <div class="row">
                              ...
                              <div class="col-12 ml-3">
                                ...
                                if ($result != null) {
                                  foreach ($result as $resultvlu) {
                                    if (!empty($resultvlu->agencyname)) {
                                      $agencyNameExists = true;
                                      break;
                                    }
                                  }
                                }
                                  ...
                                  <div class="block-content">
                                    ...
                                    <table style="width: 100%;border-collapse: collapse;">
                                      <tr style=" border: 1px solid black; ">
                                        <td colspan="3" style="text-align: left;   padding: 3px !important;">
                                          <h2 class="no-margin" style="color:grey;"></h2>
                                        </td>
                                        <td colspan="3" style="text-align: left;    padding: 3px !important;">
                                          <h2 class="no-margin" style="text-align:right;">TRN: <?= $resultvlu->contact_no ?> </h2>
                                        </td>
                                      </tr>
                                    ...
                                    <div>
                                      <table style="width: 50%; float:left;" class="tab">
                                        <tr style="">
                                          <td colspan="3" style="text-align: left;   padding: 3px !important;">
                                            <h2 class="no-margin" style="color:grey;">Customer</h2>
                                          </td>
                                          <td colspan="3" style="text-align: left;    padding: 3px !important;">
                                            <h2 class="no-margin" style="text-align:right;"></h2>
                                          </td>
                                        </tr>
                                      ...
                                      <table style="width: 50%;border-collapse: collapse;" class="tab">
                                        <tr style="">
                                          <td colspan="3" style="text-align: left;   padding: 3px !important;">
                                            <h2 class="no-margin" style="color:grey;">Delivery/Receiver</h2>
                                          </td>
                                          <td colspan="3" style="text-align: left;    padding: 3px !important;">
                                            <h2 class="no-margin" style="text-align:right;"></h2>
                                          </td>
                           ...
                           9898-9856-7879  
                                    ...
                                    <div style="  clear:both">
                                      <table style="width: 50%; float:left; " class="tab">
                                        <tr style="">
                                          <td colspan="3" style="text-align: left;   padding: 3px !important;">
                                            <h2 class="no-margin" style="color:grey;">Cargo Details</h2>
                                          </td>
                                          <td colspan="3" style="text-align: left;    padding: 3px !important;">
                                            <h2 class="no-margin" style="text-align:right;"></h2>
                                          </td>
                                      ...
                                      <table style="width: 50%;border-collapse: collapse;" class="tab">
                                        <tr style="">
                                          <td colspan="3" style="text-align: left;   padding: 3px !important;">
                                            <h2 class="no-margin" style="color:grey;">Charges&Payments</h2>
                                          </td>
                                          <td colspan="3" style="text-align: left;    padding: 3px !important;">
                                            <h2 class="no-margin" style="text-align:right;"></h2>
                                          </td>
                          ...
                          Date: <h2 class="no-margin"><?=  $resultvlu->received_date!=''? $resultvlu->received_date: $resultvlu->sendingdate ?></h2>
                            ...
                            <div class="row  ">
                              <div class="col-12 declaration" style="margin-left:20px; color:black">
                                ...
                                <p style="text-align:justify;">I, NOUJAS holder of Emirates ID number: 786-1989-8579792-1 hereby declare that all the above said items are my personal effects/home appliances sending to my Mother Mr./Mrs. AYISHABI
