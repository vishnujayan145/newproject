                    ...
                    <div class="card">
                        <div class="card-body">                        
                            <div class="btn-group" role="group" aria-label="Basic outlined example">
                                ...
                                <button type="button" class="btn btn-outline-primary" onclick="location.href='<?= base_url() ?>goods_details/create'" ><i class="fas fa-plus " style="font-size:16px;margin-right:5px;"></i> Add Goods details </button>
                                <button type="button" class="btn btn-outline-primary" onclick="addCargosModel();"> Add Cargos </button>
                                <button type="button" class="btn btn-outline-primary" onclick="location.href='<?= base_url() ?>goods_details/printall'" ><i class="mdi mdi-printer "  style="font-size:20px;margin-right:5px;"></i> Print all </button>
                                ...
                                <button type="button" class="btn btn-outline-primary" onclick="actiononselected(3)"><i class="mdi mdi-printer " style="font-size:20px;margin-right:5px;"></i>Print Selected POD</button>
                                <button type="button" class="btn btn-outline-primary" onclick="actiononselected(4)"><i class="mdi mdi-printer " style="font-size:20px;margin-right:5px;"></i>Print Blank POD</button>
                                <button type="button" class="btn btn-outline-primary" onclick="actiononselected(2)"><i class="mdi mdi-trash-can-outline " style="font-size:20px;margin-right:5px;"></i>Delete</button>
                            </div> 
                            ...
                            <div class="row mt-2">   
                                <div class="col-md-3"> 
                                        <div class="btn-group mt-4"  role="group" aria-label="Basic outlined example">
                                            <button type="button" class="btn btn-sm btn-outline-warning"><input type="submit" class="form-control" name="download_to_import" value="Download"></button>
                                            <button type="button" class="btn btn-sm btn-outline-warning" ><input type="submit" class="form-control" name="download_loading" value="Loading List"></button>
                                            <button type="button" class="btn btn-sm btn-outline-warning" > <input type="submit" class="form-control" name="download_sorting" value="Sorting List"></button>
                                            <button type="button" class="btn btn-sm btn-outline-warning" > <input type="submit" class="form-control" name="download_ogm" value="OGM"></button> 
                                        </div>
                                ...
                                <div class="col-md-1"><label for="example-select">Date</label>
                                    <input type="date" class="form-control" name="date" placeholder="date" value="<?php if (isset($_GET['date'])) {  echo $_GET['date'];  } ?>">
                                </div>
                                <div class="col-md-2"><label for="example-select">Filter</label>                                                                                
                                ...
                                <div class="col-md-2"><label for="example-select">Value</label>                                
                                ...
                                <div class="col-md-1 pr-0 pl-0"><label for="example-select">&nbsp;&nbsp;</label>                                
