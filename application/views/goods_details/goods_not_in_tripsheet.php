            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Goods Not In Tripsheet</h4>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <form action="<?= base_url() ?>goods_details/goodsNotInTripsheet?" method="get" name="myxfrm" enctype="multipart/form-data" onsubmit="return validateForm();">

                         
                        <div class="row"> 
                            <div class="col-md-2">
                                <div class="btn-group "  role="group" aria-label="Basic outlined example">
                                <button type="button" class="btn btn-outline-warning"> <input type="submit" class="form-control" name="export_goods_not_in_tripsheet" value="Download Goods Not in Tripsheet"> </button> 
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="row mt-2">   
                                    ...
                                    <div class="col-md-2"><label for="example-select">Trip No</div>
                                ...
                                <div class="col-md-2 mt-2">
                                    ...
                                    <div class="col-md-2 mt-2">                                   
                                        <input type="date" class="form-control" value="<?php echo $today; ?>" name="date" placeholder="date" value="<?php if (isset($_GET['date'])) {  echo $_GET['date'];  } ?>">
                                    </div>  
                                    <div class="col-md-2 mt-2">                                   
