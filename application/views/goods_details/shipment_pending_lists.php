...
<div class="main-content">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <form action="<?= base_url() ?>goods_details/listTransferGoodsById/<?= $transfer_id ?>" method="get" name="myxfrm" enctype="multipart/form-data" onsubmit="return validateForm();">
                                <div class="row mt-2">
                                    <div class="col-md-2"><label for="trip_no">Trip No</label></div>
                                    <div class="col-md-2"><label for="date">Date</label></div>
                                    <div class="col-md-2"><label for="serachq">Filter</label></div>
                                    <div class="col-md-2"><label for="inptvalue">Value</label></div>
                                </div>

                                <div class="row">
                                    <div class="col-md-2">
                                        <select multiple id="trip_no" name="trip_no[]" data-allow-clear="1">
                                            <?php foreach ($trip_no_arr as $trip_no) { ?>
                                                <option <?php if (!empty($_GET['trip_no']) && in_array($trip_no->trip_no, $_GET['trip_no'])) {
                                                            echo 'selected="true"';
                                ...
                                <div class="table-responsive mb-0" data-pattern="priority-columns">
                                    <table id="tech-companies-1" class="table table-striped1 ">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                    <tr class="<?= trim($resultvlu->rewight) != '' ? 'table-warning' : '' ?>">
                                                        <td>
    ...
    <script type="text/javascript">
        ...
        <script>
document.getElementById('rewight').addEventListener('keypress', function(event) {
    if (event.key === 'Enter') {
        event.preventDefault(); // Prevent the default form submission
        document.getElementById('EditPopup').click(); // Trigger the submit button click
    }
});
</script>