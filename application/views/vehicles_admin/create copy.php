                    ...
                    <div class="block">
                        <div class="block-content">
                            <div class="block">
                                ...
                                <div class="block-content">
                                     <form action="<?=base_url()?>vehicles_admin/create_process" method="post" name="myxfrm" enctype="multipart/form-data" onsubmit="return validateForm();">
                                        ...
                                        <div class="form-group">
                                            <a href="<?=base_url()?>vehicles_admin" class="btn btn-alt-primary">Back</a> &nbsp;<button type="submit" class="btn btn-alt-success">Complete</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
