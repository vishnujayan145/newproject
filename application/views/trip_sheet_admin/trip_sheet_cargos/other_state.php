                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">                        
                            ...
                            <form action="<?= base_url() ?>trip_sheet_admin/cargos_other_state/<?= $this->uri->segment(3) ?>?" method="get" name="myxfrm" enctype="multipart/form-data" onsubmit="return validateForm();">
                                <div class="row mt-4">    
                                                    ...
                                                    if ($result != null) {
                                                        ...
                                                        foreach ($result as $key => $resultvlu) {
                                                            ...
                                                            // }
                                                                ...
                                                                <div class="btn-group" role="group" aria-label="Basic outlined example">
                                                                    <button type="button" class="btn btn-outline-danger"  onclick="location.href='<?= base_url() ?>trip_sheet_admin/cargos_delete_process_other_state/<?= $this->uri->segment(3) ?>/<?= $resultvlu->id ?>'"  data-toggle="tooltip" title="Delete cargo" ><i class="mdi mdi-trash-can-outline"  style="font-size: 22px"></i></button>      
                ...
                <div class="modal-body">
                    <div class=" mb-4">
                        ...
                        <div class="row justify-content-center">
                            ...
                            <form class="form-horizontal form-label-left ajaxModel" method="post"  action="<?= base_url() ?>trip_sheet_admin/updateLrNo" enctype = multipart/form-data>
