                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="row"  style="float:right;">                              
                                <div class="col-md-12"> 
                                    <a href="<?=base_url()?>trip_sheet_admin/create" class="btn btn-primary">
                                    ...
                                    ?>
                                        <tr style="<?=$bgcolor?>">
                                            ...
                                            <td class="text-center">  
                                                ...
                                                <button type="button" class="btn btn-outline-secondary" onclick="location.href='<?=base_url()?>trip_sheet_admin/print/<?=$resultvlu->id?>'" ><i class="mdi mdi-printer"  style="font-size: 22px"></i></button> 
                                                <?php  if($resultvlu->destination =='other_state') { ?> 
                                                    <button type="button" class="btn btn-outline-secondary" onclick="location.href='<?=base_url()?>trip_sheet_admin/cargos_other_state/<?=$resultvlu->id?>'" >
                                                    <i class="fa fa-truck"  style="font-size: 22px"></i></button>  
                                                <?php } else { ?>
                                                        <button type="button" class="btn btn-outline-secondary" onclick="location.href='<?=base_url()?>trip_sheet_admin/cargos/<?=$resultvlu->id?>'" >
                                                        <i class="fa fa-truck"  style="font-size: 22px"></i></button>                                                        
                                                <?php }  ?>

                                                <button type="button" class="btn btn-outline-secondary" onclick="location.href='<?= base_url() ?>trip_sheet_admin/update/<?= $resultvlu->id ?>'" >  <i class="fas fa-pencil-alt"  style="font-size: 22px"></i> </button>   
