                            ...
                            <div class="block">
                                ...
                                <div class="block-content">
                                     <form action="<?=base_url()?>vehicles_admin/update_process" method="post" name="myxfrm" enctype="multipart/form-data" onsubmit="return validateForm();">
                                        ...
                                        <div class="form-group">
                                            <a href="<?=base_url()?>vehicles_admin" class="btn btn-alt-primary">Back</a> &nbsp;
                                            <a href="<?=base_url()?>vehicles_admin/delete_process/<?=$id?>" class="btn btn-danger mr-2">Delete</a>&nbsp;<button type="submit" class="btn btn-alt-success">Update Now</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
