                    ...
                    <div class="block">
                        ...
                        <div class="block-content">
                            ...
                            <div class="block">
                                ...
                                <div class="block-content">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div>
                                            ...
                                            <div class="col-4 col-md-4 vehicle">   
                                                <div class="form-group">  
                                            ...
                                            <div class="col-4 col-md-4 vendor">
                                    <div class="form-group">
                                ...
                                <!-- <div class="col-4 col-md-4 vendor">
                                    <div class="form-group">
                                        <label for="example-nf-email">Vendor Email</label>
                                        <input type="text" class="form-control" name="vendor_email"
                                               id='vendor_email' placeholder="vendor email">
                                    </div>
                                </div> -->
                                ...
                                <div class="col-4 col-md-4 vendor">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="vendor_location"
                                               id='vendor_location' placeholder="vendor location.." value="<?=$vendor_location?>">
                                        <input type="hidden" class="form-control" name="vendor_name"
                                               id='vendor_name' placeholder="vendor location.." value="<?=$vendor_name?>">
                                    </div>
                                </div> 
...
<!-- 
                                        ...
                                        <div class="form-group">
                                            ...
                                            <button type="submit" class="btn btn-alt-success">Update Now</button>
...
$(document).ready(function(){
    ...
    var vendor_or_vehicle = '<?php echo $vendor_or_vehicle; ?>';

    if( vendor_or_vehicle == 'vehicle' ||  vendor_or_vehicle == '' ||  vendor_or_vehicle == null){
        $('.vehicle').show();
        $('.vendor').hide();
...
if (person == 'Indianlive@2324') { 
    window.location = "<?= base_url() ?>trip_sheet/delete_process/"+id;     
