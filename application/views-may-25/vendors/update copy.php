<main id="main-container">
                ...
                <!-- Page Content -->
                <div class="content">
                    <h2 class="content-heading">Vendors</h2>
                        ...
                        <div class="block-content">
                            <div class="block">
                                <div class="block-header block-header-default">
                                    <h3 class="block-title">Update Vendor</h3>
                                </div>
                                <div class="block-content">
                                     <form action="<?=base_url()?>vendors/update_process" method="post" name="myxfrm" enctype="multipart/form-data" onsubmit="return validateForm();">
                                        ...
                                        <div class="form-group">
                                            <label for="example-nf-email">Vendor Name</label>
                                        ...
                                        <div class="form-group">
                                            <a href="<?=base_url()?>vendors" class="btn btn-alt-primary">Back</a> &nbsp;
                                            <a href="<?=base_url()?>vendors/delete_process/<?=$id?>" class="btn btn-danger mr-2">Delete</a>&nbsp;<button type="submit" class="btn btn-alt-success">Update Now</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
