            ...
            <div class="block-content">
                ...
                <div class="row my-20">
                    ...
                    <div class="col-12 ml-3">
                        ...
                        if ($header){
                        ?>
                            <img src="<?= base_url() ?>assets/uploads/headers/<?=$header?>" style="width:96%;display: block;margin-right: auto;">
                        <?php
                        }else{
                        ?>
                        ...
                        <table class="table table-hover" style="border: 1px solid black; ">
                            ...
                            if ($trip_sheet_cargos != null) {
                                ...
                                foreach ($trip_sheet_cargos as $key => $trip_sheet_cargosvlu) {
                                    ...
                                    $total_pcs = $total_pcs + $trip_sheet_cargosvlu->quantity;
                                    $total_weight = $total_weight + $trip_sheet_cargosvlu->weight;
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"
                                            style="border: 1px solid black; font-weight: bold; color:black; padding: 0px;"><?= $trip_sheet_cargosvlu->boxno ?></td> 
                                        <td class="text-center" style="border: 1px solid black; font-weight: bold; color:black; padding: 0px;">
                                            <?= $trip_sheet_cargosvlu->invoice_number ?>
                                        </td>
                                        <td class="text-center"
                                            style="border: 1px solid black; font-weight: bold; color:black; padding: 0px;"><?= $trip_sheet_cargosvlu->quantity ?></td>
                                        <td class="text-center"
                                            style="border: 1px solid black; font-weight: bold; color:black; padding: 0px;"><?= $trip_sheet_cargosvlu->weight ?></td>
                                        <td class="text-center"
