        ...
        <div class="block">
            <div class="block-header block-header-default" style="    padding: 0px;">
                 <span class="block-title" style="    padding: 0px;">
                     <h2 class="content-heading" style="    padding: 0px;">Shipment Pending Goods</h2>
                 </span>
               
                 <input class="btn btn-alt-primary" type="button" value="Confirm Received"  onclick="confirmReceived();"/> &nbsp;&nbsp;
                 <!-- <input class="btn btn-alt-primary" type="button" value="Back To Goods"  onclick="backToGoodsGoods();"/>    &nbsp; -->
         ...
         <div class="modal-content">
             ...
             <div class="modal-body" id="model">
                <form class="form-horizontal form-label-left ajaxModel" method="post" action="<?= base_url() ?>goods_details/confirm_back_to_goods">  
                     ...
                     <input name="sel_goods_id_shipment" id="sel_goods_id_shipment" type="hidden" value="">
                     <input name="transfer_id" id="transfer_id" value="<?=$transfer_id?>" type="hidden">
...
$('#allcb').click(function (e) {
   ...
   document.getElementById( 'confirmReceivedGoods').addEventListener('click', (e) => {
    ...
    function backToGoodsGoods() {       
        
        var checkValues = $('.checkbox-item:checked').map(function(){
            return $(this).val();
        }).get();
        document.getElementById("sel_goods_id_shipment").value = checkValues; 
