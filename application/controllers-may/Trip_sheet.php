...
{ 
    ...
    public function reports()
    {
        ...
        $searchqry = array_merge($searchqry,array("trip_sheet_cargos.branch_id"=> $branch_id )); 
        ...
        if(!empty( $checkValues)){  
            $invoice_nos_lrno = $this->crud_model->get_all_lrno_by_invoice('trip_sheet_cargos','invoice_number' , $checkValues);
                ...
                $html = '<div>
                        ...
                        <tr> 
                        <th >Url : <input type="text" name="url" class="form-control" placeholder="Please enter url.." value="'. $res[0]->url.'"> ( eg: http://www.google.com )<br></th>
